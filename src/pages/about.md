...
<section class="flow region region-space-m">
    ...
    <ul class="cluster" role="list">
      <li>
        <a href="/tags/houdini/" class="button">Houdini</a>
      </li>
      <li>
        <a href="/tags/unity/" class="button">Unity</a>
      </li>
      <li>
        <a href="/tags/blender/" class="button">Blender</a>
      </li>
      <li>
        <a href="/tags/photography/" class="button">Photography</a>
      </li>
